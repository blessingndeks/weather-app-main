...
Links
Solution URL: [Add GitHub Repo Link]
Live Site URL: [Add Live Deployment Link]
My process
Built with
Semantic HTML5
CSS custom properties (design system vibes)
Flexbox & CSS Grid
Vanilla JavaScript (modular + state-driven)
Open-Meteo API (weather + geocoding)
Mobile-first workflow
What I learned

This project lowkey leveled me up from “frontend dev” to “frontend engineer”.
...
Yeah, AI was part of the squad on this one 🤝
